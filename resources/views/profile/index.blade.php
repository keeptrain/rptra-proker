        ...
        <div class="bg-white dark:bg-zinc-900  rounded-lg shadow-sm p-6">
            <div class="flex items-center space-x-6">
                ...
                <div class="relative w-32 h-32">
                    ...
                    <div class="w-full h-full rounded-full overflow-hidden border border-gray-300">
                        <img src="{{ Auth::user()->image }}" alt="Profile Picture" class="w-full h-full object-cover">
                    </div>
                    ...
                    <button onclick="window.location.href = '{{ route('profile.setting') }}'"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-black dark:text-white fill-current"
            ...
            <div class="mt-6 flex justify-end">
                <form action="{{ route('auth.logout') }}" method="POST">
                    @csrf
                    <x-button
                        class="bg-red-500 text-white px-4 py-2 shadow-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75">
                        Logout
                    </x-button>
                </form>
            </div>
