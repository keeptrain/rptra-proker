<div class="flex flex-col flex-shrink-0 w-full">
    ...
    <nav>
        <div class="flex-grow m-1.5 md:block md:overflow-y-auto overflow-x-hidden"
            ...
            <a class="flex justify-start items-center px-4 py-3 hover:bg-zinc-100 rounded-xl dark:hover:bg-zinc-700 focus:bg-gray-200 hover:text-black dark:hover:text-white {{ request()->is('/*') ? 'bg-white dark:bg-blue-900 dark:text-white rounded-xl' : '' }}"
            ...
            <a class="flex items-center px-4 py-3 hover:bg-zinc-100 rounded-xl dark:hover:bg-zinc-700 focus:bg-gray-200 hover:text-black dark:hover:text-white {{ request()->is('program-kerja/prioritas*') ? 'bg-gray-200 dark:bg-blue-900 dark:text-white rounded-xl' : '' }}"
            ...
            <a class="flex items-center px-4 py-3 hover:bg-zinc-100 rounded-xl dark:hover:bg-zinc-700 focus:bg-gray-200 hover:text-black dark:hover:text-white {{ request()->is('program-kerja/pokok*') ? 'bg-gray-200 dark:bg-blue-900 dark:text-white rounded-xl' : '' }}"
            ...
            <a class="flex items-center px-4 py-3  hover:bg-zinc-100 rounded-xl dark:hover:bg-zinc-700 focus:bg-gray-200 hover:text-black dark:hover:text-white {{ request()->is('program-kerja/mitra*') ? 'bg-gray-200 dark dark:bg-blue-900 dark:text-white rounded-xl' : '' }}"
            ...
            <div>
                <a class="flex items-center px-4 py-3 hover:bg-zinc-100 rounded-xl dark:hover:bg-zinc-700 focus:bg-gray-200 hover:text-black dark:hover:text-white {{ request()->is('program-kerja/transaksi*') ? 'bg-gray-200 dark:bg-blue-900 dark:text-white rounded-xl ' : '' }} cursor-default"
