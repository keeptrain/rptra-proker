    ...
    <div class="flex flex-col flex-shrink-0 w-full">
        ...
        <nav>
            <div class="flex-grow md:block md:overflow-y-auto overflow-x-hidden"
                ...
                <a class="flex items-center px-4 py-3 hover:bg-zinc-700 focus:bg-gray-200 hover:text-white focus:outline-none focus:ring {{ request()->is('program-kerja/prioritas*') ? 'bg-gray-200 dark:bg-blue-900 dark:text-white' : '' }}"
                ...
                <a class="flex items-center px-4 py-3 hover:bg-zinc-700 focus:bg-gray-200 hover:text-white focus:outline-none focus:ring {{ request()->is('program-kerja/pokok*') ? 'bg-gray-200 dark:bg-blue-900 dark:text-white' : '' }}"
                ...
                <a class="flex items-center px-4 py-3 hover:bg-zinc-700 focus:bg-gray-200 hover:text-white focus:outline-none focus:ring {{ request()->is('program-kerja/mitra*') ? 'bg-gray-200 dark dark:bg-blue-900 dark:text-white' : '' }}"
                ...
                <div x-data="{ open: false }">
                    <a @click="open = !open" class="flex items-center px-4 py-3 hover:bg-zinc-700 focus:bg-gray-200 hover:text-white focus:outline-none focus:ring">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-5 h-5 fill-current" viewBox="0 0 16 16">
                    ...
                    <div x-show="open" class="pl-3">
                        <a href="{{ route('prog-transaksi.index') }}" class="flex items-center px-4 py-2 text-sm  hover:bg-zinc-700 focus:bg-gray-200 hover:text-white">
                            <span class="flex-grow mx-4">- Data</span>
                        </a>
                        <a href="{{ route('prog-transaksi.show.draft') }}" class="flex items-center  px-4 py-2 text-sm  hover:bg-zinc-700 focus:bg-gray-200 hover:text-white">
