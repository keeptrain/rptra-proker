        ...
        <div
            ...
            <div class="border-b dark:border-zinc-700 pl-6 pr-6 pt-4 pb-4 ">
                <div class="flex justify-between items-center ">
                    ...
                    <x-button onclick="window.location.href='{{ route('prog-transaksi.index') }}';" color="zinc"
            ...
            <div class="grid grid-cols-4 ">
                ...
                <div class="col-span-3 pl-6 p-6">
                    <div class="grid grid-cols-[auto,1fr] gap-y-3 gap-x-4">
                        ...
                        <div>{{ $selectedProgram->priorityPrograms->name ?? '' }}</div>

                        <div class="font-semibold text-gray-400 dark:text-gray-500">
                            {{ __('PROGRAM POKOK') }}
                        </div>
                        <div>{{ $selectedProgram->principalPrograms->name ?? '' }}</div>
                        ...
                        <div>{{ $selectedProgram->objective ?? '' }}</div>

                        <div class="font-semibold text-gray-400 dark:text-gray-500">
                            {{ __('OUTPUT') }}
                        </div>
                        <div>{{ $selectedProgram->output ?? '' }}</div>

                        <div class="font-semibold text-gray-400 dark:text-gray-500">
                            {{ __('TARGET') }}
                        </div>
                        <div>{{ $selectedProgram->target ?? '' }}</div>
