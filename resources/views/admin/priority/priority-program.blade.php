...
@if (Route::currentRouteName() === 'proker.show')

<form action="{{ route('progprio.destroy') }}" method="POST">
    @csrf
    @method('DELETE')
    <x-admin.table :programs="$programs">
        ...
        <x-slot name="tbody">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="w-4 p-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="priority_ids[]" value="{{ $program->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
@elseif (Route::currentRouteName() === 'proker.create')
    <x-admin.add-form/>
@endif
@endsection
