...
<div class="relative overflow-x-auto  sm:rounded-lg">
    <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white">
        <div>
            ...
            <button type="submit" class=" px-3 py-2 bg-blue-600 text-white font-medium text-sm rounded-lg focus:ring-1 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <a href="prioritas/tambah">Tambah </a>
            </button>
