<div class="bg-white dark:bg-transparent flex overflow-hidden">
    <div class="flex border dark:border-zinc-800 shadow-sm">
        <!-- Tombol Hapus -->
        <button id="delete-selected-button" type="button" onclick="confirmDelete();"
        ...
        <!-- Tombol Export -->
        <button id="export-selected-button" type="button" onclick="exportData();"
